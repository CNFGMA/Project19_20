...
double beta_inf(int N_inf);                   // beta varies in function of the infected cells next to the selected cell
inline double beta_inf(int N_inf){
  double beta = 0.5;                                // probability that a cell next to an infected cell becomes infected
